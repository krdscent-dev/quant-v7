"""Smoke tests for the Tushare adapter layer."""
...
from data_sources.tushare_provider import TushareDataProvider, ts
...
def main() -> None:
    ...
    print(f"tushare_installed={ts is not None}")
    print(f"provider_initialized={provider.tushare_available}")
    ...
    if ts is None:
        print("tushare_missing_graceful_degradation=ok")
    else:
        print("tushare_present_adapter_payloads=ok")
