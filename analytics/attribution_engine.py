"""Performance attribution for the V12.6 replay layer."""
...
class AttributionResult:
    """Layer-level contribution summary."""

    total_pnl: float
    total_return: float
    market_structure_contribution: float
    capital_control_contribution: float
...
class AttributionEngine:
    ...
    def analyze(
        ...
        return AttributionResult(
            ...
            market_structure_contribution=round(layer_totals["market_structure"], 6),
            capital_control_contribution=round(layer_totals["capital_control"], 6),
